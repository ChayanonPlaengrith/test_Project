...
if ($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
        ...
        "🧼รหัสสินค้า : " ."<a href='editproduct.php?ProductId=$row[ProductId]'>".$row["ProductId"]."</a>"."<br>"
        ."ชื่อสินค้า : ".$row["ProductName"]."<br>"
        ."ราคา: ".$row["Price"]."<br>"
        ."วันผลิต : ".$row["CDate"]."<br>"
        ."วันหมดอายุ : ".$row["ModDate"]."<br>"
        ."สถานะ : ".$row["Deleted"]."<hr>"."<br><br><br>";
    ...
    echo "<br>";
    echo "<a class = 'btn btn-light' href='insertproduct.php'>Add New Product</a>"."<br>"."<br>"."<br>"."<br>";
